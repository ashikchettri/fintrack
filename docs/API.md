...
| `GET · PUT /api/v1/household/net-worth/items` | The editable manual balance sheet (assets/liabilities); PUT replaces it wholesale (ADR 014) |
| `GET /api/v1/household/net-worth` | Net-worth summary: total assets/liabilities/net, folding in the home loan (balance as a liability, offset as an asset) |
