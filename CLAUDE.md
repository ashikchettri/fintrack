...
- **React 19 SPA**: every flow above — Dashboard, Insights (AI summary + Q&A), Cash flow, Home loan, Income & expenses, Profile (household roster + invites), Settings; charts (donut/bar/payoff); light/dark.
